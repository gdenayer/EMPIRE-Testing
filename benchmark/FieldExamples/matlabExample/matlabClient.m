...
numNodesPerElem=[4];
elems=[1,2,3,4];
EMPIRE_API_sendMesh('myMesh_1', numNodes, numElems, nodes', nodeIDs, numNodesPerElem, elems);
...
EMPIRE_API_sendDataField('fieldName',12, df1');
EMPIRE_API_recvDataField('fieldName',12, df1');
