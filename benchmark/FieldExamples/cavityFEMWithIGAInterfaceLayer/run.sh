...
if [ $# -eq 1 ]; then
	if [ $1 = 'ICC' ]; then
		...
		carat cavityFEMWithIGAInterfaceLayerCaratFEM/cavityFEMWithIGAInterfaceLayerCaratFEM_5Elem.dat >/dev/null 2>outputCaratFEM.err &
...
#		carat cavityFEMWithIGAInterfaceLayerCaratIGA/cavityFEMWithIGAInterfaceLayerCaratIGA.dat >/dev/null 2>outputCaratIGA.err &
		carat cavityFEMWithIGAInterfaceLayerCaratIGA/cavityFEMWithIGAInterfaceLayerCaratIGA2Patches.dat >/dev/null 2>outputCaratIGA.err &
